...
"""
You can uncomment the following code to preprocess the original VGGFace2 dataset and run BAAT on it.
Or you can directly use our preprocessed dataset in the `datasets` folder.
"""
# preprocess_vggface2()
